...
public class NewHabit extends AppCompatActivity implements ChooseDaysDialogFragment.NoticeDialogListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView daysViewButton = (TextView) findViewById(R.id.days_view);
